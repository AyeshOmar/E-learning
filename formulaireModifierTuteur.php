...
$id=$_GET['id'];
   $sql="select * from tuteur where id =$id";
...
$sql="UPDATE `tuteur` SET `username`='$username',`password`='$password',`Nom`='$nom',`téléphone`='$telephone' WHERE  `id`=$id";
...
<div class="inputfield">
        <a href="welcome.php" class="cancel"> cancel </a>
       </div>
